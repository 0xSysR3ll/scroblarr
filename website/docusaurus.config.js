  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: "light",
        links: [],
        copyright: `© ${new Date().getFullYear()} Scroblarr · Plex, Jellyfin, Trakt, Simkl, and related marks are trademarks of their respective owners. This project is independent and is not sponsored, endorsed, or affiliated with those services.`,
        logo: {
          alt: "Scroblarr",
          src: "img/logo-icon.svg",
          href: "/",
