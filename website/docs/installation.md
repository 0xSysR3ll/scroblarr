...
- **Trakt**, **Simkl**, and/or **Bingers** accounts when you're ready to sync out (you can link those after install)
...
5. Paste webhook URLs into Plex/Jellyfin and link Trakt, Simkl, or Bingers when you're ready
