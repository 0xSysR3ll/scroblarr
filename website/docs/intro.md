...
**Scroblarr** is a self-hosted service that syncs watch history from **Plex** and **Jellyfin** to **Trakt** and **TVTime** using webhooks—no manual logging. For badges, releases, and repo-wide info, see the [README on GitHub](https://github.com/0xsysr3ll/scroblarr/blob/main/README.md).
